<nav class="col-2 order-2 order-md-1 collapse d-md-flex pt-0 px-0 min-vh-100 cstm-max-width bg-dark dashboard" id="sidebar">
    <ul class="nav flex-column flex-nowrap overflow-hidden mt-3">
        <li class="nav-item">
            <a class="nav-link text-truncate" href="#"><i class="far fa-chart-bar"></i> <span
                    class="d-none d-sm-inline">Dashboard</span></a>
        </li>
        {{-- <li class="nav-item">
            <a class="nav-link collapsed text-truncate" href="#submenu1" data-toggle="collapse"
                data-target="#submenu1"><i class="fa fa-table"></i> <span class="d-none d-sm-inline">Reports</span></a>
        ...
        {{-- <li class="nav-item"><a class="nav-link text-truncate" href="#"><i class="fa fa-bar-chart"></i>
